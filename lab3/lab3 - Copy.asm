...
finalize:	call resetR6			! reset r6
		halt
		add %r6, 12, %r6
		st %r31, %r6			! store results at %r6
		add %r0, 32, %r23		! set r23 to 28
		clr %r22			! set r22 to 0
shiftNo:	ldub %r6, %r16
		srl %r16, 4, %r16
		subcc %r16, 9, %r12
		ble num1
		addcc %r16, 7, %r12
num1:		addcc %r12, 57, %r12		
		sethi charCode, %r8
		srl %r8, 10, %r8
		st %r12, %r8
		call printSub
...
! ****************************************
! printSubroutine. r8 stores address of printString
printSub:	clr %r9			! reset string indexer
...
! 3 digit storage
		.org 2800
char:		.dwb 5				! reserve 3 space at 2800
...
testSuccess:	or %r15, %r0, %r19		! backup r15 to secondary jump
		...
		srl %r8, 10, %r8		! 
		call printSub			! call - print subroutine
